...
export const getBanners = async (
  ...
  try {
    ...
    const data = await cmsExtrasService.getBanners({
      placement,
...
export const getFaqs = async (
  ...
  try {
    ...
    const data = await cmsExtrasService.getFaqs({
      search,
      categoryId,
...
export const deleteFaq = async (
  ...
  try {
    await cmsExtrasService.deleteFaq(req.params['id'], req.user!.userId);
...
export const getTestimonials = async (
  ...
  try {
    ...
    const data = await cmsExtrasService.getTestimonials({
...
export const updateTestimonial = async (
  ...
  try {
    const data = await cmsExtrasService.updateTestimonial(
      req.params['id'],
      req.body,
      req.user!.userId,
    );
...
export const deleteTestimonial = async (
  ...
  try {
    await cmsExtrasService.deleteTestimonial(req.params['id'], req.user!.userId);
...
export const getMediaFiles = async (
  ...
  try {
    ...
    const data = await cmsExtrasService.getMediaFiles({
      search,
      folder,
      fileType,
      page: page ? +page : undefined,
...
export const uploadMediaFile = async (
  ...
  try {
    ...
    const { folder, altText } = req.body as Record<string, string>;
    const data = await cmsExtrasService.uploadMedia(
      req.file,
      { folder, altText },
      req.user!.userId,
    );
    sendCreated(res, 'Media uploaded', data);
  } catch (e) {
    next(e);
  }
};
...
export const updateMediaFile = async (
  ...
  try {
    const data = await cmsExtrasService.updateMediaFile(req.params['id'], req.body, req.user!.userId);
...
export const deleteMediaFile = async (
  ...
  try {
    await cmsExtrasService.deleteMediaFile(req.params['id'], req.user!.userId);
...
export const globalCMSSearch = async (
  req: AuthenticatedRequest,
  res: Response,
  next: NextFunction,
): Promise<void> => {
...
export const updateFaqCategory = async (
  ...
  try {
    const data = await cmsExtrasService.updateFaqCategory(
      req.params['id'],
      req.body,
      req.user!.userId,
    );
