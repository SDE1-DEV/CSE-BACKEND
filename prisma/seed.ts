...
async function main() {
      ...
      for (let i = 0; i < practiceData.length; i++) {
        ...
        await prisma.lessonPracticeQuestion.create({
          data: {
            ...
            difficulty: pd.diff as 'BEGINNER' | 'INTERMEDIATE' | 'ADVANCED',
            displayOrder: i,
          },
        })
        totalPq++
  ...
  console.log(
    `✅ Learning: Programming category + Python roadmap (${sectionDefs.length} sections, ${pythonLessons.length} lessons, ${totalQz} quiz Qs, ${totalPq} practice Qs)`
  )
  ...
  const problemCategories = [
    { name: 'Arrays', slug: 'arrays', description: 'Array manipulation and traversal', displayOrder: 1 },
    { name: 'Strings', slug: 'strings', description: 'String processing and pattern matching', displayOrder: 2 },
    { name: 'Linked List', slug: 'linked-list', description: 'Singly and doubly linked lists', displayOrder: 3 },
    { name: 'Stack', slug: 'stack', description: 'Stack-based problems and patterns', displayOrder: 4 },
    ...
    { name: 'Binary Search Tree', slug: 'binary-search-tree', description: 'BST operations and properties', displayOrder: 7 },
    { name: 'Binary Tree', slug: 'binary-tree', description: 'Binary tree traversals and algorithms', displayOrder: 8 },
    { name: 'Graph', slug: 'graph', description: 'Graph traversal, shortest paths, and more', displayOrder: 9 },
    { name: 'Dynamic Programming', slug: 'dynamic-programming', description: 'DP problems and patterns', displayOrder: 10 },
    { name: 'Greedy', slug: 'greedy', description: 'Greedy algorithm problems', displayOrder: 11 },
    { name: 'Recursion', slug: 'recursion', description: 'Recursive thinking and backtracking', displayOrder: 12 },
    { name: 'Hashing', slug: 'hashing', description: 'HashMap and HashSet problems', displayOrder: 13 },
    { name: 'Heap', slug: 'heap', description: 'Priority queue and heap problems', displayOrder: 14 },
    { name: 'Sliding Window', slug: 'sliding-window', description: 'Sliding window technique', displayOrder: 15 },
    { name: 'Two Pointer', slug: 'two-pointer', description: 'Two pointer technique', displayOrder: 16 },
    { name: 'Prefix Sum', slug: 'prefix-sum', description: 'Prefix sum and range queries', displayOrder: 17 },
    { name: 'Bit Manipulation', slug: 'bit-manipulation', description: 'Bitwise operations and tricks', displayOrder: 18 },
    { name: 'Backtracking', slug: 'backtracking', description: 'Backtracking and constraint satisfaction', displayOrder: 19 },
    { name: 'Trie', slug: 'trie', description: 'Trie data structure problems', displayOrder: 20 },
    { name: 'Matrix', slug: 'matrix', description: '2D array and matrix problems', displayOrder: 21 },
    { name: 'Sorting', slug: 'sorting', description: 'Sorting algorithms and applications', displayOrder: 22 },
    { name: 'Searching', slug: 'searching', description: 'Search algorithms', displayOrder: 23 },
    { name: 'Math', slug: 'math', description: 'Mathematical problems and proofs', displayOrder: 24 },
    { name: 'Number Theory', slug: 'number-theory', description: 'Primes, GCD, modular arithmetic', displayOrder: 25 },
    { name: 'Geometry', slug: 'geometry', description: 'Computational geometry problems', displayOrder: 26 },
    { name: 'Simulation', slug: 'simulation', description: 'Simulation-based problems', displayOrder: 27 },
    { name: 'Binary Search', slug: 'binary-search', description: 'Binary search on sorted arrays and answer space', displayOrder: 28 },
    { name: 'Divide and Conquer', slug: 'divide-and-conquer', description: 'Divide and conquer algorithms', displayOrder: 29 },
    { name: 'Segment Tree', slug: 'segment-tree', description: 'Segment tree range queries', displayOrder: 30 },
    { name: 'Fenwick Tree', slug: 'fenwick-tree', description: 'Binary indexed tree / Fenwick tree', displayOrder: 31 },
  ]
  ...
  const problemTags = [
    ...
    { name: 'Binary Search', slug: 'binary-search-tag' }, { name: 'Graph', slug: 'graph-tag' },
    { name: 'Tree', slug: 'tree-tag' }, { name: 'Greedy', slug: 'greedy-tag' },
    { name: 'Sliding Window', slug: 'sliding-window-tag' }, { name: 'HashMap', slug: 'hashmap' },
  ]
  ...
  const companies = [
    ...
    { name: 'Meta', slug: 'meta', industry: 'Technology', headquarters: 'Menlo Park, CA', website: 'https://meta.com', verified: true },
    { name: 'Adobe', slug: 'adobe', industry: 'Technology', headquarters: 'San Jose, CA', website: 'https://adobe.com', verified: true },
    { name: 'Oracle', slug: 'oracle', industry: 'Technology', headquarters: 'Austin, TX', website: 'https://oracle.com', verified: true },
    { name: 'Apple', slug: 'apple', industry: 'Technology', headquarters: 'Cupertino, CA', website: 'https://apple.com', verified: true },
  ...
  console.log(`✅ Coding: ${problemCategories.length} topics (Question Bank), ${problemTags.length} tags, ${companies.length} companies — no demo questions (FPRD-16)`)
  ...
  const jobs = [
    { companySlug: 'google', title: 'Software Engineer Intern', type: 'INTERNSHIP' as const, workMode: 'ONSITE' as const, location: 'Bangalore', description: 'Summer 2026 SWE internship.', salaryRange: 'Γé╣1,00,000/month', isPublished: true },
    { companySlug: 'amazon', title: 'SDE-1', type: 'FULL_TIME' as const, workMode: 'HYBRID' as const, location: 'Hyderabad', description: 'Entry-level backend engineer.', salaryRange: 'Γé╣28 LPA', isPublished: true },
    { companySlug: 'flipkart', title: 'Frontend Engineer', type: 'FULL_TIME' as const, workMode: 'REMOTE' as const, location: 'Remote', description: 'React/TypeScript frontend role.', salaryRange: 'Γé╣22 LPA', isPublished: false },
  ]
  for (const j of jobs) {
